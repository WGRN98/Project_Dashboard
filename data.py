...
plotly_fig.add_trace(go.Scatter(x=data.index, y=data['total load'],
                    mode='lines+markers'))
pkl.dump(plotly_fig,open('plot_load','wb'))
...
plotly_fig.add_trace(go.Scatter(x=data.index, y=data['total generation'],
                    mode='lines+markers'))
pkl.dump(plotly_fig,open('plot_generation','wb'))
...
plotly_fig.add_trace(go.Scatter(x=data.index, y=data['price'],
                    mode='lines+markers'))
pkl.dump(plotly_fig,open('plot_price','wb'))
...
pkl.dump(plotly_fig,open('elbow','wb'))
...
plt.show()
plotly_fig=px.scatter(data, x="total load", y="total generation", color=data['cluster']+2)
pkl.dump(plotly_fig,open('cluster_1','wb'))

fig=data.plot.scatter(x='price', y='total load', color=data['cluster'])
plt.show()
plotly_fig=px.scatter(data, x="price", y="total load", color=data['cluster']+1)
pkl.dump(plotly_fig,open('cluster_2','wb'))
...
pkl.dump(plotly_fig,open('cluster_3','wb'))
...
pkl.dump(plotly_fig,open('cluster_6','wb'))
...
pkl.dump(plotly_fig,open('cluster_7','wb'))
...
pkl.dump(plotly_fig,open('cluster_8','wb'))
...
pkl.dump(plotly_fig,open('cluster_9','wb'))
...
#print("Feature Ranking (Linear Model, 2 features): %s" % (fit.ranking_)) 
...
pkl.dump(plotly_fig,open('fore_pl1_1','wb'))
fig=plt.scatter(y_test,y_pred_LR)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_LR)
pkl.dump(plotly_fig,open('fore_pl1_2','wb'))
#Evaluate errors
...
pkl.dump(plotly_fig,open('fore_pl3_1','wb'))
fig=plt.scatter(y_test,y_pred_DT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_DT)
pkl.dump(plotly_fig,open('fore_pl3_2','wb'))
#Evaluate errors
...
pkl.dump(plotly_fig,open('fore_pl4_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pl4_2','wb'))
#Evaluate errors
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_RF[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pl5_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pl5_2','wb'))
#Evaluate errors
MAE_RF=metrics.mean_absolute_error(y_test,y_pred_RF) 
MSE_RF=metrics.mean_squared_error(y_test,y_pred_RF)  
RMSE_RF= np.sqrt(metrics.mean_squared_error(y_test,y_pred_RF))
...
pkl.dump(plotly_fig,open('fore_pl6_1','wb'))
fig=plt.scatter(y_test,y_pred_GB)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_GB)
pkl.dump(plotly_fig,open('fore_pl6_2','wb'))
#Evaluate errors
...
pkl.dump(plotly_fig,open('fore_pl7_1','wb'))
fig=plt.scatter(y_test,y_pred_XGB)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_XGB)
pkl.dump(plotly_fig,open('fore_pl7_2','wb'))
#Evaluate errors
...
pkl.dump(plotly_fig,open('fore_pl8_1','wb'))
fig=plt.scatter(y_test,y_pred_BT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_BT)
pkl.dump(plotly_fig,open('fore_pl8_2','wb'))
#Evaluate errors
...
pkl.dump(plotly_fig,open('fore_pl9_1','wb'))
fig=plt.scatter(y_test,y_pred_NN)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_NN)
pkl.dump(plotly_fig,open('fore_pl9_2','wb'))
#Evaluate errors
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_LR[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg1_1','wb'))
fig=plt.scatter(y_test,y_pred_LR)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_LR)
pkl.dump(plotly_fig,open('fore_pg1_2','wb'))
#Evaluate errors
MAE_LR=metrics.mean_absolute_error(y_test,y_pred_LR) 
MSE_LR=metrics.mean_squared_error(y_test,y_pred_LR)  
RMSE_LR= np.sqrt(metrics.mean_squared_error(y_test,y_pred_LR))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_SVR2[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg2_1','wb'))
fig=plt.scatter(y_test,y_pred_SVR2)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_SVR2)
pkl.dump(plotly_fig,open('fore_pg2_2','wb'))
#Evaluate errors
MAE_SVR=metrics.mean_absolute_error(y_test,y_pred_SVR2) 
MSE_SVR=metrics.mean_squared_error(y_test,y_pred_SVR2)  
RMSE_SVR= np.sqrt(metrics.mean_squared_error(y_test,y_pred_SVR2))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_DT[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg3_1','wb'))
fig=plt.scatter(y_test,y_pred_DT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_DT)
pkl.dump(plotly_fig,open('fore_pg3_2','wb'))
#Evaluate errors
MAE_DT=metrics.mean_absolute_error(y_test,y_pred_DT) 
MSE_DT=metrics.mean_squared_error(y_test,y_pred_DT)  
RMSE_DT= np.sqrt(metrics.mean_squared_error(y_test,y_pred_DT))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_RF[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg4_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pg4_2','wb'))
#Evaluate errors
MAE_RF=metrics.mean_absolute_error(y_test,y_pred_RF) 
MSE_RF=metrics.mean_squared_error(y_test,y_pred_RF)  
RMSE_RF= np.sqrt(metrics.mean_squared_error(y_test,y_pred_RF))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_RF[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg5_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pg5_2','wb'))
#Evaluate errors
MAE_RF=metrics.mean_absolute_error(y_test,y_pred_RF) 
MSE_RF=metrics.mean_squared_error(y_test,y_pred_RF)  
RMSE_RF= np.sqrt(metrics.mean_squared_error(y_test,y_pred_RF))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_GB[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg6_1','wb'))
fig=plt.scatter(y_test,y_pred_GB)
plt.show()
plotly_fig=go.Figure()
plotly_fig=px.scatter(x=y_test, y=y_pred_GB)
pkl.dump(plotly_fig,open('fore_pg6_2','wb'))
#Evaluate errors
MAE_GB=metrics.mean_absolute_error(y_test,y_pred_GB) 
MSE_GB=metrics.mean_squared_error(y_test,y_pred_GB)  
RMSE_GB= np.sqrt(metrics.mean_squared_error(y_test,y_pred_GB))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_XGB[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg7_1','wb'))
fig=plt.scatter(y_test,y_pred_XGB)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_XGB)
pkl.dump(plotly_fig,open('fore_pg7_2','wb'))
#Evaluate errors
MAE_XGB=metrics.mean_absolute_error(y_test,y_pred_XGB) 
MSE_XGB=metrics.mean_squared_error(y_test,y_pred_XGB)  
RMSE_XGB= np.sqrt(metrics.mean_squared_error(y_test,y_pred_XGB))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_BT[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg8_1','wb'))
fig=plt.scatter(y_test,y_pred_BT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_BT)
pkl.dump(plotly_fig,open('fore_pg8_2','wb'))
#Evaluate errors
MAE_BT=metrics.mean_absolute_error(y_test,y_pred_BT) 
MSE_BT=metrics.mean_squared_error(y_test,y_pred_BT)  
RMSE_BT= np.sqrt(metrics.mean_squared_error(y_test,y_pred_BT))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_NN[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pg9_1','wb'))
fig=plt.scatter(y_test,y_pred_NN)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_NN)
pkl.dump(plotly_fig,open('fore_pg9_2','wb'))
#Evaluate errors
MAE_NN=metrics.mean_absolute_error(y_test,y_pred_NN) 
MSE_NN=metrics.mean_squared_error(y_test,y_pred_NN)  
RMSE_NN= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_LR[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp1_1','wb'))
fig=plt.scatter(y_test,y_pred_LR)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_LR)
pkl.dump(plotly_fig,open('fore_pp1_2','wb'))
#Evaluate errors
MAE_LR=metrics.mean_absolute_error(y_test,y_pred_LR) 
MSE_LR=metrics.mean_squared_error(y_test,y_pred_LR)  
RMSE_LR= np.sqrt(metrics.mean_squared_error(y_test,y_pred_LR))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_SVR2[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp2_1','wb'))
fig=plt.scatter(y_test,y_pred_SVR2)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_SVR2)
pkl.dump(plotly_fig,open('fore_pp2_2','wb'))
#Evaluate errors
MAE_SVR=metrics.mean_absolute_error(y_test,y_pred_SVR2) 
MSE_SVR=metrics.mean_squared_error(y_test,y_pred_SVR2)  
RMSE_SVR= np.sqrt(metrics.mean_squared_error(y_test,y_pred_SVR2))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_DT[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp3_1','wb'))
fig=plt.scatter(y_test,y_pred_DT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_DT)
pkl.dump(plotly_fig,open('fore_pp3_2','wb'))
#Evaluate errors
MAE_DT=metrics.mean_absolute_error(y_test,y_pred_DT) 
MSE_DT=metrics.mean_squared_error(y_test,y_pred_DT)  
RMSE_DT= np.sqrt(metrics.mean_squared_error(y_test,y_pred_DT))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_RF[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp4_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pp4_2','wb'))
#Evaluate errors
MAE_RF=metrics.mean_absolute_error(y_test,y_pred_RF) 
MSE_RF=metrics.mean_squared_error(y_test,y_pred_RF)  
RMSE_RF= np.sqrt(metrics.mean_squared_error(y_test,y_pred_RF))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_RF[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp5_1','wb'))
fig=plt.scatter(y_test,y_pred_RF)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_RF)
pkl.dump(plotly_fig,open('fore_pp5_2','wb'))
#Evaluate errors
MAE_RF=metrics.mean_absolute_error(y_test,y_pred_RF) 
MSE_RF=metrics.mean_squared_error(y_test,y_pred_RF)  
RMSE_RF= np.sqrt(metrics.mean_squared_error(y_test,y_pred_RF))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_GB[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp6_1','wb'))
fig=plt.scatter(y_test,y_pred_GB)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_GB)
pkl.dump(plotly_fig,open('fore_pp6_2','wb'))
#Evaluate errors
MAE_GB=metrics.mean_absolute_error(y_test,y_pred_GB) 
MSE_GB=metrics.mean_squared_error(y_test,y_pred_GB)  
RMSE_GB= np.sqrt(metrics.mean_squared_error(y_test,y_pred_GB))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_XGB[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp7_1','wb'))
fig=plt.scatter(y_test,y_pred_XGB)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_XGB)
pkl.dump(plotly_fig,open('fore_pp7_2','wb'))
#Evaluate errors
MAE_XGB=metrics.mean_absolute_error(y_test,y_pred_XGB) 
MSE_XGB=metrics.mean_squared_error(y_test,y_pred_XGB)  
RMSE_XGB= np.sqrt(metrics.mean_squared_error(y_test,y_pred_XGB))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_BT[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp8_1','wb'))
fig=plt.scatter(y_test,y_pred_BT)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_BT)
pkl.dump(plotly_fig,open('fore_pp8_2','wb'))
#Evaluate errors
MAE_BT=metrics.mean_absolute_error(y_test,y_pred_BT) 
MSE_BT=metrics.mean_squared_error(y_test,y_pred_BT)  
RMSE_BT= np.sqrt(metrics.mean_squared_error(y_test,y_pred_BT))
...
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_test[1:200],mode='lines',name='actual'))
plotly_fig.add_trace(go.Scatter(x=x_plot, y=y_pred_NN[1:200],mode='lines',name='predition'))
pkl.dump(plotly_fig,open('fore_pp9_1','wb'))
fig=plt.scatter(y_test,y_pred_NN)
plt.show()
plotly_fig=px.scatter(x=y_test, y=y_pred_NN)
pkl.dump(plotly_fig,open('fore_pp9_2','wb'))
#Evaluate errors
MAE_NN=metrics.mean_absolute_error(y_test,y_pred_NN) 
MSE_NN=metrics.mean_squared_error(y_test,y_pred_NN)  
RMSE_NN= np.sqrt(metrics.mean_squared_error(y_test,y_pred_NN))
...
#Best method for consumption and generation was random forest
#Best method for price was extreme gradient boosting